...
import { ArrowRight, Brain, Calendar, Heart, ShieldCheck } from "lucide-react";
      ...
      <div className="bt-hero-inner">
        <div className="bt-hero-shell mx-auto max-w-content px-2 pb-6 pt-10 sm:px-6 sm:pb-8 sm:pt-12 lg:px-8 lg:pb-10 lg:pt-14">
          <div className="bt-hero-copy bt-fade-up">
            ...
            <p className="mt-4 text-sm font-semibold text-bt-ink/80">
              Or call{" "}
              <a
                href={site.phoneHref}
                className="text-bt-accent-text underline decoration-bt-accent/40 underline-offset-2 transition hover:text-bt-accent-hover"
              >
                {site.phone}
              </a>
            </p>
