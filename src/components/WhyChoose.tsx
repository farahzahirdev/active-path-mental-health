...
import { CheckCircle2, HeartHandshake, MapPin, ShieldCheck, Sparkles, Stethoscope, Zap } from "lucide-react";
import { copy } from "@/content/copy";
import { site } from "@/content/site";
import { Reveal, StaggerGrid } from "./Reveal";
import { SectionHeader } from "./SectionHeader";

const icons = [HeartHandshake, ShieldCheck, Sparkles, MapPin, Stethoscope, Zap];

const trustHighlights = [
  "Care that never gives up",
  "Insurance accepted",
  "6 OR & WA locations",
] as const;
...
export function WhyChoose() {
  return (
    <section id="why-choose" className="why-choose-section bt-section scroll-mt-24 bt-section-alt">
